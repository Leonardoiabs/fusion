    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.FileField(upload_to='equipe', verbose_name='Imagem')),
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.cargo', verbose_name='Cargo')),
            ],
            options={
